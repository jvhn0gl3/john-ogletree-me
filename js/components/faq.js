    ...
    render() {
        return `
            <section id="faq-section" class="faq-section">
                <h2 id="faq-heading" class="m-0 mt-14 mb-6 border-b border-border pb-2 font-mono font-medium text-heading text-xl before:mr-2 before:font-normal before:text-text-light before:content-['##'] md:text-2xl">
                    Frequently Asked Questions
                </h2>
                
                <div id="faq-list">
                    ${this.faqs.map((faq, index) => `
                        <details id="faq-${index}" class="mb-4 rounded-lg border border-border bg-surface p-6">
